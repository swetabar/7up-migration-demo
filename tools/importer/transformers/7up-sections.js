...
/**
 * Transformer: 7up section breaks and section metadata.
 * Inserts <hr> before each non-first section (in beforeTransform, before parsers
 * can replace section elements) and Section Metadata blocks for styled sections
 * (in afterTransform, anchored to a temporary marker).
