...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-products-7up.js
  var import_products_7up_exports = {};
  __export(import_products_7up_exports, {
    default: () => import_products_7up_default
  });
  ...
  var import_products_7up_default = {
    transform: (payload) => {
      const {
        document,
        url,
  ...
  return __toCommonJS(import_products_7up_exports);
})();
