...
const PAGE_TEMPLATE = {
  name: 'home',
  description: '7up homepage: full-bleed promotional banners (lime hero, store locator, flip-the-sip).',
  urls: [
  ...
  blocks: [
    {
      name: 'hero-banner',
      instances: [
        '#simple-7up-banner-new > div.banner-wrapper1',
        '#simple-7up-banner-new > div.banner-wrapper3',
      ],
    },
  ],
  sections: [
...
// TRANSFORMER REGISTRY - cleanup first, then sections (afterTransform adds <hr> breaks)
const transformers = [
  cleanupTransformer,
